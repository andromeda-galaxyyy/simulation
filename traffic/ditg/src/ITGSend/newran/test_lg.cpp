...
int my_main() {
    ...
    max_error_pos = max_error_neg = 0.0;
    int sign_error = 0;
    for (i = 1; i <= 75; ++i) {
        int i1 = i - 1;
        X1_3p *= (long_Real) i1 + 1.0L / 3.0L;
    ...
    max_error_pos = 0.0;
    diff = spot_check(0.901);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(0.95);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(0.99);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(1.01);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(1.05);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(1.099);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(1.901);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(1.95);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(1.99);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(2.01);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(2.05);
    if (max_error_pos < diff) max_error_pos = diff;
    diff = spot_check(2.099);
    if (max_error_pos < diff) max_error_pos = diff;
